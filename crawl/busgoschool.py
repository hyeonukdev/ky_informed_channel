...
for col in range(1,12):
    if col!=11:
        data[''.join(menu_list[0][col])] = {''.join(menu_list[1][0]):menu_list[1][col], ''.join(menu_list[2][0]):menu_list[2][col], ''.join(menu_list[3][0]):menu_list[3][col], ''.join(menu_list[4][0]):menu_list[4][col], ''.join(menu_list[5][0]):menu_list[5][col], ''.join(menu_list[6][0]):menu_list[6][col]}
    else:
        data[''.join(menu_list[0][col])] = {''.join(menu_list[1][0]):menu_list[1][col], ''.join(menu_list[2][0]):menu_list[2][col], ''.join(menu_list[3][0]):menu_list[2][col], ''.join(menu_list[4][0]):menu_list[2][col], ''.join(menu_list[5][0]):menu_list[2][col], ''.join(menu_list[6][0]):menu_list[6][col]}
